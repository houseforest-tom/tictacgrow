...
public class MultiplayerSession extends JSONObject
{
	...
	private static final String JSON_KEY_ID 				= "uuid",
	...
	{ 
		try { return getString(JSON_KEY_ID); }
		catch (JSONException e) { Log.e("app", "Error extracting Value from JSON Document!", e); return null; }
	}
	
	//return the names of the users participating in the game session
	public final String getUsername(PlayerIndex player)
	{ 
		try { return getString(JSON_KEY_USERS).split(";")[player.ordinal()]; }
		catch (JSONException e) { Log.e("app", "Error extracting Value from JSON Document!", e); return null; }
	}
	...
	{
		try { return PlayerIndex.valueOf(PlayerIndex.class, getString(JSON_KEY_CURRENT_PLAYER_ID)); }
		catch (JSONException e) { Log.e("app", "Error extracting Value from JSON Document!", e); return null; }
	}
	...
	{
		try { return getString(JSON_KEY_BOARD_STATE); }
		catch (JSONException e) { Log.e("app", "Error extracting Value from JSON Document!", e); return null; }
	}
