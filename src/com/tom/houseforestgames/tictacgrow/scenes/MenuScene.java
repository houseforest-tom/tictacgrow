...
public class MenuScene extends GameScene
{
	...
	{		
		...
		mMuteSprites[0 /* unmuted */] = new Sprite(muteSpriteX, muteSpriteY, muteSpriteSz, muteSpriteSz, Utility.load(mActivity, "unmuted.png", 512, 512), mVBOMgr);
		mMuteSprites[1 /* muted   */] = new Sprite(muteSpriteX, muteSpriteY, muteSpriteSz, muteSpriteSz, Utility.load(mActivity,   "muted.png", 512, 512), mVBOMgr);
		...
		mAISelectArrows[0] = new Sprite(aiArrowLeftX, aiArrowY, navArrowW * 0.7f, navArrowH * 0.7f, Utility.load(mActivity, "navigate.png", 512, 512), mVBOMgr);
		mAISelectArrows[0].setRotation(270);
		mAISelectArrows[0].setVisible(false);
		mAISelectArrows[1] = new Sprite(aiArrowRightX, aiArrowY, navArrowW * 0.7f, navArrowH * 0.7f, Utility.load(mActivity, "navigate.png", 512, 512), mVBOMgr);
	...
	@Override public void onUpdate(float delta, float total)
	{
		...
		{
			if(wasTouched((int)mAISelectArrows[1].getX(), (int)mAISelectArrows[1].getY(), (int)mAISelectArrows[1].getWidth(), (int)mAISelectArrows[1].getHeight()))
			{
				mAILevelIndex++;
			...
			else if(wasTouched((int)mAISelectArrows[0].getX(), (int)mAISelectArrows[0].getY(), (int)mAISelectArrows[0].getWidth(), (int)mAISelectArrows[0].getHeight()))
			{
				mAILevelIndex--;
				while(mAILevelIndex < 0) mAILevelIndex += AILevel.values().length;
				mAILevelText.setText(AILevel.values()[mAILevelIndex].name());
				Utility.centerTextX(mAILevelText, 576);
				mActivity.playSFX(SFXName.CLICK);
			}
