...
{	 
	...
	LOGGED_IN_MENU_ENTRIES = new String[]
	{
		"* Challenge Friend *",
		"* Edit Profile *",
		"* Logout *",
	...
	@Override protected void onSetup(RenderSurfaceRatio ratio) 
	{
				...
				case 0:
					Utility.showCustomDialog(
							...
							new OnClickListener() 
							{
								...
								{
									mActivity.getMultiplayerManager().queryAuthenticateUser(
											((EditText)(mActivity.findViewById(R.id.username))).getText().toString(),
											((EditText)(mActivity.findViewById(R.id.password))).getText().toString()
									);
